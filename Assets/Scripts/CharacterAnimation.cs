...
public class CharacterAnimation : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        if (idle < 1)
        {
            ...
            float lowerBodyDeltaAngleTarget = Mathf.DeltaAngle(HorizontalAngle(tr.rotation * animatedLocalVelocity), HorizontalAngle(velocity));
...
public class MoveAnimation
{
    ...
    public void Init()
    {
        ...
        angle = CharacterAnimation.HorizontalAngle(velocity);
    }
